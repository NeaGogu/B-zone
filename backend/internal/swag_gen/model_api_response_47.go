...
// ApiResponse47 struct for ApiResponse47
type ApiResponse47 struct {
...
func (o ApiResponse47) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse47 struct {
	value *ApiResponse47
	isSet bool
}

func (v NullableApiResponse47) Get() *ApiResponse47 {
	return v.value
}

func (v *NullableApiResponse47) Set(val *ApiResponse47) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse47) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse47) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse47(val *ApiResponse47) *NullableApiResponse47 {
	return &NullableApiResponse47{value: val, isSet: true}
}

func (v NullableApiResponse47) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse47) UnmarshalJSON(src []byte) error {
	v.isSet = true
