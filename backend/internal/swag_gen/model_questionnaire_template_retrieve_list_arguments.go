...
// QuestionnaireTemplateRetrieveListArguments struct for QuestionnaireTemplateRetrieveListArguments
type QuestionnaireTemplateRetrieveListArguments struct {
	Options *QuestionnaireTemplateOptionsModel `json:"options,omitempty"`
	Filters *QuestionnaireTemplateFiltersModel `json:"filters,omitempty"`
	// 
...
func NewQuestionnaireTemplateRetrieveListArguments() *QuestionnaireTemplateRetrieveListArguments {
	this := QuestionnaireTemplateRetrieveListArguments{}
	return &this
}
...
func (o *QuestionnaireTemplateRetrieveListArguments) GetOptions() QuestionnaireTemplateOptionsModel {
	if o == nil || o.Options == nil {
		var ret QuestionnaireTemplateOptionsModel
		return ret
	}
	return *o.Options
}
...
// SetOptions gets a reference to the given QuestionnaireTemplateOptionsModel and assigns it to the Options field.
...
func (o *QuestionnaireTemplateRetrieveListArguments) GetFilters() QuestionnaireTemplateFiltersModel {
	if o == nil || o.Filters == nil {
		var ret QuestionnaireTemplateFiltersModel
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given QuestionnaireTemplateFiltersModel and assigns it to the Filters field.
...
func (o QuestionnaireTemplateRetrieveListArguments) MarshalJSON() ([]byte, error) {
...
type NullableQuestionnaireTemplateRetrieveListArguments struct {
	value *QuestionnaireTemplateRetrieveListArguments
	isSet bool
}

func (v NullableQuestionnaireTemplateRetrieveListArguments) Get() *QuestionnaireTemplateRetrieveListArguments {
	return v.value
}

func (v *NullableQuestionnaireTemplateRetrieveListArguments) Set(val *QuestionnaireTemplateRetrieveListArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableQuestionnaireTemplateRetrieveListArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableQuestionnaireTemplateRetrieveListArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuestionnaireTemplateRetrieveListArguments(val *QuestionnaireTemplateRetrieveListArguments) *NullableQuestionnaireTemplateRetrieveListArguments {
	return &NullableQuestionnaireTemplateRetrieveListArguments{value: val, isSet: true}
}

func (v NullableQuestionnaireTemplateRetrieveListArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuestionnaireTemplateRetrieveListArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
