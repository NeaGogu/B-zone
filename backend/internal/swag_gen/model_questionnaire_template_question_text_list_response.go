...
// QuestionnaireTemplateQuestionTextListResponse struct for QuestionnaireTemplateQuestionTextListResponse
type QuestionnaireTemplateQuestionTextListResponse struct {
	// 
	Items *[]QuestionnaireTemplateQuestionTextModel `json:"items,omitempty"`
...
func NewQuestionnaireTemplateQuestionTextListResponse() *QuestionnaireTemplateQuestionTextListResponse {
	this := QuestionnaireTemplateQuestionTextListResponse{}
	return &this
}
...
// SetItems gets a reference to the given []QuestionnaireTemplateQuestionTextModel and assigns it to the Items field.
...
func (o QuestionnaireTemplateQuestionTextListResponse) MarshalJSON() ([]byte, error) {
...
type NullableQuestionnaireTemplateQuestionTextListResponse struct {
	value *QuestionnaireTemplateQuestionTextListResponse
	isSet bool
}

func (v NullableQuestionnaireTemplateQuestionTextListResponse) Get() *QuestionnaireTemplateQuestionTextListResponse {
	return v.value
}

func (v *NullableQuestionnaireTemplateQuestionTextListResponse) Set(val *QuestionnaireTemplateQuestionTextListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableQuestionnaireTemplateQuestionTextListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableQuestionnaireTemplateQuestionTextListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuestionnaireTemplateQuestionTextListResponse(val *QuestionnaireTemplateQuestionTextListResponse) *NullableQuestionnaireTemplateQuestionTextListResponse {
	return &NullableQuestionnaireTemplateQuestionTextListResponse{value: val, isSet: true}
}

func (v NullableQuestionnaireTemplateQuestionTextListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuestionnaireTemplateQuestionTextListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
