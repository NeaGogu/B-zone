...
// ApiResponse43 struct for ApiResponse43
type ApiResponse43 struct {
...
func (o ApiResponse43) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse43 struct {
	value *ApiResponse43
	isSet bool
}

func (v NullableApiResponse43) Get() *ApiResponse43 {
	return v.value
}

func (v *NullableApiResponse43) Set(val *ApiResponse43) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse43) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse43) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse43(val *ApiResponse43) *NullableApiResponse43 {
	return &NullableApiResponse43{value: val, isSet: true}
}

func (v NullableApiResponse43) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse43) UnmarshalJSON(src []byte) error {
	v.isSet = true
