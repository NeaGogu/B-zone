...
// ApiResponse52 struct for ApiResponse52
type ApiResponse52 struct {
...
func (o ApiResponse52) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse52 struct {
	value *ApiResponse52
	isSet bool
}

func (v NullableApiResponse52) Get() *ApiResponse52 {
	return v.value
}

func (v *NullableApiResponse52) Set(val *ApiResponse52) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse52) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse52) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse52(val *ApiResponse52) *NullableApiResponse52 {
	return &NullableApiResponse52{value: val, isSet: true}
}

func (v NullableApiResponse52) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse52) UnmarshalJSON(src []byte) error {
	v.isSet = true
