...
// PartyListResponse struct for PartyListResponse
type PartyListResponse struct {
	// 
	Items *[]PartyModel `json:"items,omitempty"`
...
// SetItems gets a reference to the given []PartyModel and assigns it to the Items field.
...
func (o PartyListResponse) MarshalJSON() ([]byte, error) {
...
type NullablePartyListResponse struct {
	value *PartyListResponse
	isSet bool
}

func (v NullablePartyListResponse) Get() *PartyListResponse {
	return v.value
}

func (v *NullablePartyListResponse) Set(val *PartyListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePartyListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePartyListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartyListResponse(val *PartyListResponse) *NullablePartyListResponse {
	return &NullablePartyListResponse{value: val, isSet: true}
}

func (v NullablePartyListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartyListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
