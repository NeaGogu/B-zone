...
// QuestionnaireQuestionTypeRetrieveListArguments struct for QuestionnaireQuestionTypeRetrieveListArguments
type QuestionnaireQuestionTypeRetrieveListArguments struct {
	Options *QuestionnaireQuestionTypeOptionsModel `json:"options,omitempty"`
	Filters *QuestionnaireQuestionTypeFiltersModel `json:"filters,omitempty"`
	// 
...
func NewQuestionnaireQuestionTypeRetrieveListArguments() *QuestionnaireQuestionTypeRetrieveListArguments {
	this := QuestionnaireQuestionTypeRetrieveListArguments{}
	return &this
}
...
func (o *QuestionnaireQuestionTypeRetrieveListArguments) GetOptions() QuestionnaireQuestionTypeOptionsModel {
	if o == nil || o.Options == nil {
		var ret QuestionnaireQuestionTypeOptionsModel
		return ret
	}
	return *o.Options
}
...
// SetOptions gets a reference to the given QuestionnaireQuestionTypeOptionsModel and assigns it to the Options field.
...
func (o *QuestionnaireQuestionTypeRetrieveListArguments) GetFilters() QuestionnaireQuestionTypeFiltersModel {
	if o == nil || o.Filters == nil {
		var ret QuestionnaireQuestionTypeFiltersModel
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given QuestionnaireQuestionTypeFiltersModel and assigns it to the Filters field.
...
func (o QuestionnaireQuestionTypeRetrieveListArguments) MarshalJSON() ([]byte, error) {
...
type NullableQuestionnaireQuestionTypeRetrieveListArguments struct {
	value *QuestionnaireQuestionTypeRetrieveListArguments
	isSet bool
}

func (v NullableQuestionnaireQuestionTypeRetrieveListArguments) Get() *QuestionnaireQuestionTypeRetrieveListArguments {
	return v.value
}

func (v *NullableQuestionnaireQuestionTypeRetrieveListArguments) Set(val *QuestionnaireQuestionTypeRetrieveListArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableQuestionnaireQuestionTypeRetrieveListArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableQuestionnaireQuestionTypeRetrieveListArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuestionnaireQuestionTypeRetrieveListArguments(val *QuestionnaireQuestionTypeRetrieveListArguments) *NullableQuestionnaireQuestionTypeRetrieveListArguments {
	return &NullableQuestionnaireQuestionTypeRetrieveListArguments{value: val, isSet: true}
}

func (v NullableQuestionnaireQuestionTypeRetrieveListArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuestionnaireQuestionTypeRetrieveListArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
