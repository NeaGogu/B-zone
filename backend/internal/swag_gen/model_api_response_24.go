...
// ApiResponse24 struct for ApiResponse24
type ApiResponse24 struct {
...
func (o ApiResponse24) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse24 struct {
	value *ApiResponse24
	isSet bool
}

func (v NullableApiResponse24) Get() *ApiResponse24 {
	return v.value
}

func (v *NullableApiResponse24) Set(val *ApiResponse24) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse24) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse24) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse24(val *ApiResponse24) *NullableApiResponse24 {
	return &NullableApiResponse24{value: val, isSet: true}
}

func (v NullableApiResponse24) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse24) UnmarshalJSON(src []byte) error {
	v.isSet = true
