...
// ApiResponse41 struct for ApiResponse41
type ApiResponse41 struct {
...
func (o ApiResponse41) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse41 struct {
	value *ApiResponse41
	isSet bool
}

func (v NullableApiResponse41) Get() *ApiResponse41 {
	return v.value
}

func (v *NullableApiResponse41) Set(val *ApiResponse41) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse41) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse41) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse41(val *ApiResponse41) *NullableApiResponse41 {
	return &NullableApiResponse41{value: val, isSet: true}
}

func (v NullableApiResponse41) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse41) UnmarshalJSON(src []byte) error {
	v.isSet = true
