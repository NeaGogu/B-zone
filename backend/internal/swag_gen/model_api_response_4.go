...
// ApiResponse4 struct for ApiResponse4
type ApiResponse4 struct {
...
func (o ApiResponse4) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse4 struct {
	value *ApiResponse4
	isSet bool
}

func (v NullableApiResponse4) Get() *ApiResponse4 {
	return v.value
}

func (v *NullableApiResponse4) Set(val *ApiResponse4) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse4) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse4(val *ApiResponse4) *NullableApiResponse4 {
	return &NullableApiResponse4{value: val, isSet: true}
}

func (v NullableApiResponse4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse4) UnmarshalJSON(src []byte) error {
	v.isSet = true
