...
// ApiResponse55 struct for ApiResponse55
type ApiResponse55 struct {
...
func (o ApiResponse55) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse55 struct {
	value *ApiResponse55
	isSet bool
}

func (v NullableApiResponse55) Get() *ApiResponse55 {
	return v.value
}

func (v *NullableApiResponse55) Set(val *ApiResponse55) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse55) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse55) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse55(val *ApiResponse55) *NullableApiResponse55 {
	return &NullableApiResponse55{value: val, isSet: true}
}

func (v NullableApiResponse55) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse55) UnmarshalJSON(src []byte) error {
	v.isSet = true
