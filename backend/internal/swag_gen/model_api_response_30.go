...
// ApiResponse30 struct for ApiResponse30
type ApiResponse30 struct {
...
func (o ApiResponse30) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse30 struct {
	value *ApiResponse30
	isSet bool
}

func (v NullableApiResponse30) Get() *ApiResponse30 {
	return v.value
}

func (v *NullableApiResponse30) Set(val *ApiResponse30) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse30) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse30) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse30(val *ApiResponse30) *NullableApiResponse30 {
	return &NullableApiResponse30{value: val, isSet: true}
}

func (v NullableApiResponse30) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse30) UnmarshalJSON(src []byte) error {
	v.isSet = true
