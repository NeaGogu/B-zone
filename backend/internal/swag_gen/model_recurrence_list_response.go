...
// RecurrenceListResponse struct for RecurrenceListResponse
type RecurrenceListResponse struct {
	// 
	Items *[]RecurrenceModel `json:"items,omitempty"`
...
// SetItems gets a reference to the given []RecurrenceModel and assigns it to the Items field.
...
func (o RecurrenceListResponse) MarshalJSON() ([]byte, error) {
...
type NullableRecurrenceListResponse struct {
	value *RecurrenceListResponse
	isSet bool
}

func (v NullableRecurrenceListResponse) Get() *RecurrenceListResponse {
	return v.value
}

func (v *NullableRecurrenceListResponse) Set(val *RecurrenceListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRecurrenceListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRecurrenceListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecurrenceListResponse(val *RecurrenceListResponse) *NullableRecurrenceListResponse {
	return &NullableRecurrenceListResponse{value: val, isSet: true}
}

func (v NullableRecurrenceListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecurrenceListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
