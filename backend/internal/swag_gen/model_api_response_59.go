...
// ApiResponse59 struct for ApiResponse59
type ApiResponse59 struct {
...
func (o ApiResponse59) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse59 struct {
	value *ApiResponse59
	isSet bool
}

func (v NullableApiResponse59) Get() *ApiResponse59 {
	return v.value
}

func (v *NullableApiResponse59) Set(val *ApiResponse59) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse59) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse59) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse59(val *ApiResponse59) *NullableApiResponse59 {
	return &NullableApiResponse59{value: val, isSet: true}
}

func (v NullableApiResponse59) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse59) UnmarshalJSON(src []byte) error {
	v.isSet = true
