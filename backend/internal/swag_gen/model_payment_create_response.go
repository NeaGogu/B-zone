...
// PaymentCreateResponse struct for PaymentCreateResponse
...
func (o PaymentCreateResponse) MarshalJSON() ([]byte, error) {
...
type NullablePaymentCreateResponse struct {
	value *PaymentCreateResponse
	isSet bool
}

func (v NullablePaymentCreateResponse) Get() *PaymentCreateResponse {
	return v.value
}

func (v *NullablePaymentCreateResponse) Set(val *PaymentCreateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentCreateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentCreateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentCreateResponse(val *PaymentCreateResponse) *NullablePaymentCreateResponse {
	return &NullablePaymentCreateResponse{value: val, isSet: true}
}

func (v NullablePaymentCreateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentCreateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
