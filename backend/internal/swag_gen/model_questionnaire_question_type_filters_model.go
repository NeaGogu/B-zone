...
// QuestionnaireQuestionTypeFiltersModel struct for QuestionnaireQuestionTypeFiltersModel
type QuestionnaireQuestionTypeFiltersModel struct {
	// QuestionnaireQuestionType id's
	Id *[]int32 `json:"id,omitempty"`
	// QuestionnaireQuestionType names
...
func NewQuestionnaireQuestionTypeFiltersModel() *QuestionnaireQuestionTypeFiltersModel {
	this := QuestionnaireQuestionTypeFiltersModel{}
	return &this
}
...
func (o QuestionnaireQuestionTypeFiltersModel) MarshalJSON() ([]byte, error) {
...
type NullableQuestionnaireQuestionTypeFiltersModel struct {
	value *QuestionnaireQuestionTypeFiltersModel
	isSet bool
}

func (v NullableQuestionnaireQuestionTypeFiltersModel) Get() *QuestionnaireQuestionTypeFiltersModel {
	return v.value
}

func (v *NullableQuestionnaireQuestionTypeFiltersModel) Set(val *QuestionnaireQuestionTypeFiltersModel) {
	v.value = val
	v.isSet = true
}

func (v NullableQuestionnaireQuestionTypeFiltersModel) IsSet() bool {
	return v.isSet
}

func (v *NullableQuestionnaireQuestionTypeFiltersModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuestionnaireQuestionTypeFiltersModel(val *QuestionnaireQuestionTypeFiltersModel) *NullableQuestionnaireQuestionTypeFiltersModel {
	return &NullableQuestionnaireQuestionTypeFiltersModel{value: val, isSet: true}
}

func (v NullableQuestionnaireQuestionTypeFiltersModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuestionnaireQuestionTypeFiltersModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
