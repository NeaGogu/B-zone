...
// NotificationRetrieveListArguments struct for NotificationRetrieveListArguments
type NotificationRetrieveListArguments struct {
	Options *NotificationOptionsModel `json:"options,omitempty"`
	Filters *NotificationFiltersModel `json:"filters,omitempty"`
	// 
...
func NewNotificationRetrieveListArguments() *NotificationRetrieveListArguments {
	this := NotificationRetrieveListArguments{}
	return &this
}
...
func (o *NotificationRetrieveListArguments) GetOptions() NotificationOptionsModel {
	if o == nil || o.Options == nil {
		var ret NotificationOptionsModel
		return ret
	}
	return *o.Options
}
...
// SetOptions gets a reference to the given NotificationOptionsModel and assigns it to the Options field.
...
func (o *NotificationRetrieveListArguments) GetFilters() NotificationFiltersModel {
	if o == nil || o.Filters == nil {
		var ret NotificationFiltersModel
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given NotificationFiltersModel and assigns it to the Filters field.
...
func (o NotificationRetrieveListArguments) MarshalJSON() ([]byte, error) {
...
type NullableNotificationRetrieveListArguments struct {
	value *NotificationRetrieveListArguments
	isSet bool
}

func (v NullableNotificationRetrieveListArguments) Get() *NotificationRetrieveListArguments {
	return v.value
}

func (v *NullableNotificationRetrieveListArguments) Set(val *NotificationRetrieveListArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationRetrieveListArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationRetrieveListArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationRetrieveListArguments(val *NotificationRetrieveListArguments) *NullableNotificationRetrieveListArguments {
	return &NullableNotificationRetrieveListArguments{value: val, isSet: true}
}

func (v NullableNotificationRetrieveListArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationRetrieveListArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
