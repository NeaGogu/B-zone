...
// ApiResponse33 struct for ApiResponse33
type ApiResponse33 struct {
...
func (o ApiResponse33) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse33 struct {
	value *ApiResponse33
	isSet bool
}

func (v NullableApiResponse33) Get() *ApiResponse33 {
	return v.value
}

func (v *NullableApiResponse33) Set(val *ApiResponse33) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse33) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse33) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse33(val *ApiResponse33) *NullableApiResponse33 {
	return &NullableApiResponse33{value: val, isSet: true}
}

func (v NullableApiResponse33) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse33) UnmarshalJSON(src []byte) error {
	v.isSet = true
