...
// ApiResponse25 struct for ApiResponse25
type ApiResponse25 struct {
...
func (o ApiResponse25) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse25 struct {
	value *ApiResponse25
	isSet bool
}

func (v NullableApiResponse25) Get() *ApiResponse25 {
	return v.value
}

func (v *NullableApiResponse25) Set(val *ApiResponse25) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse25) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse25) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse25(val *ApiResponse25) *NullableApiResponse25 {
	return &NullableApiResponse25{value: val, isSet: true}
}

func (v NullableApiResponse25) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse25) UnmarshalJSON(src []byte) error {
	v.isSet = true
