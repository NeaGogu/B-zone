...
// ServiceWindowRetrieveListArguments struct for ServiceWindowRetrieveListArguments
type ServiceWindowRetrieveListArguments struct {
	Options *map[string]interface{} `json:"options,omitempty"`
	Filters *ServiceWindowFiltersModel `json:"filters,omitempty"`
	// 
...
func NewServiceWindowRetrieveListArguments() *ServiceWindowRetrieveListArguments {
	this := ServiceWindowRetrieveListArguments{}
	return &this
}
...
func (o *ServiceWindowRetrieveListArguments) GetFilters() ServiceWindowFiltersModel {
	if o == nil || o.Filters == nil {
		var ret ServiceWindowFiltersModel
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given ServiceWindowFiltersModel and assigns it to the Filters field.
...
// and a boolean to check if the value has been set.
func (o *ServiceWindowRetrieveListArguments) GetCountOnlyOk() (*bool, bool) {
	if o == nil || o.CountOnly == nil {
		return nil, false
	}
...
func (o ServiceWindowRetrieveListArguments) MarshalJSON() ([]byte, error) {
...
type NullableServiceWindowRetrieveListArguments struct {
	value *ServiceWindowRetrieveListArguments
	isSet bool
}

func (v NullableServiceWindowRetrieveListArguments) Get() *ServiceWindowRetrieveListArguments {
	return v.value
}

func (v *NullableServiceWindowRetrieveListArguments) Set(val *ServiceWindowRetrieveListArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceWindowRetrieveListArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceWindowRetrieveListArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceWindowRetrieveListArguments(val *ServiceWindowRetrieveListArguments) *NullableServiceWindowRetrieveListArguments {
	return &NullableServiceWindowRetrieveListArguments{value: val, isSet: true}
}

func (v NullableServiceWindowRetrieveListArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceWindowRetrieveListArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
