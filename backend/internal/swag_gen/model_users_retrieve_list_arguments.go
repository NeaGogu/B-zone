...
// UsersRetrieveListArguments struct for UsersRetrieveListArguments
type UsersRetrieveListArguments struct {
	Options *UsersOptionsModel `json:"options,omitempty"`
	Filters *UsersFiltersModel `json:"filters,omitempty"`
	// 
...
func NewUsersRetrieveListArguments() *UsersRetrieveListArguments {
	this := UsersRetrieveListArguments{}
	return &this
}
...
// SetOptions gets a reference to the given UsersOptionsModel and assigns it to the Options field.
...
// SetFilters gets a reference to the given UsersFiltersModel and assigns it to the Filters field.
...
func (o UsersRetrieveListArguments) MarshalJSON() ([]byte, error) {
...
type NullableUsersRetrieveListArguments struct {
	value *UsersRetrieveListArguments
	isSet bool
}

func (v NullableUsersRetrieveListArguments) Get() *UsersRetrieveListArguments {
	return v.value
}

func (v *NullableUsersRetrieveListArguments) Set(val *UsersRetrieveListArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableUsersRetrieveListArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableUsersRetrieveListArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsersRetrieveListArguments(val *UsersRetrieveListArguments) *NullableUsersRetrieveListArguments {
	return &NullableUsersRetrieveListArguments{value: val, isSet: true}
}

func (v NullableUsersRetrieveListArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsersRetrieveListArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
