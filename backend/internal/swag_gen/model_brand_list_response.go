...
// BrandListResponse struct for BrandListResponse
type BrandListResponse struct {
	// 
	Items *[]BrandModel `json:"items,omitempty"`
...
// SetItems gets a reference to the given []BrandModel and assigns it to the Items field.
...
func (o BrandListResponse) MarshalJSON() ([]byte, error) {
...
type NullableBrandListResponse struct {
	value *BrandListResponse
	isSet bool
}

func (v NullableBrandListResponse) Get() *BrandListResponse {
	return v.value
}

func (v *NullableBrandListResponse) Set(val *BrandListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBrandListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBrandListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBrandListResponse(val *BrandListResponse) *NullableBrandListResponse {
	return &NullableBrandListResponse{value: val, isSet: true}
}

func (v NullableBrandListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBrandListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
