...
type ZoneListResponse struct {
	// 
	Items *[]ZoneModel `json:"items,omitempty"`
...
// SetItems gets a reference to the given []ZoneModel and assigns it to the Items field.
...
func (o ZoneListResponse) MarshalJSON() ([]byte, error) {
...
type NullableZoneListResponse struct {
	value *ZoneListResponse
	isSet bool
}

func (v NullableZoneListResponse) Get() *ZoneListResponse {
	return v.value
}

func (v *NullableZoneListResponse) Set(val *ZoneListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneListResponse(val *ZoneListResponse) *NullableZoneListResponse {
	return &NullableZoneListResponse{value: val, isSet: true}
}

func (v NullableZoneListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
