...
// ApiResponse22 struct for ApiResponse22
type ApiResponse22 struct {
...
func (o ApiResponse22) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse22 struct {
	value *ApiResponse22
	isSet bool
}

func (v NullableApiResponse22) Get() *ApiResponse22 {
	return v.value
}

func (v *NullableApiResponse22) Set(val *ApiResponse22) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse22) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse22) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse22(val *ApiResponse22) *NullableApiResponse22 {
	return &NullableApiResponse22{value: val, isSet: true}
}

func (v NullableApiResponse22) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse22) UnmarshalJSON(src []byte) error {
	v.isSet = true
