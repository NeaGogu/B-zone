...
// ApiResponse8 struct for ApiResponse8
type ApiResponse8 struct {
...
func (o ApiResponse8) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse8 struct {
	value *ApiResponse8
	isSet bool
}

func (v NullableApiResponse8) Get() *ApiResponse8 {
	return v.value
}

func (v *NullableApiResponse8) Set(val *ApiResponse8) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse8) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse8) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse8(val *ApiResponse8) *NullableApiResponse8 {
	return &NullableApiResponse8{value: val, isSet: true}
}

func (v NullableApiResponse8) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse8) UnmarshalJSON(src []byte) error {
	v.isSet = true
