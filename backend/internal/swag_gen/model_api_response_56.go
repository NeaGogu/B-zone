...
// ApiResponse56 struct for ApiResponse56
type ApiResponse56 struct {
...
func (o ApiResponse56) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse56 struct {
	value *ApiResponse56
	isSet bool
}

func (v NullableApiResponse56) Get() *ApiResponse56 {
	return v.value
}

func (v *NullableApiResponse56) Set(val *ApiResponse56) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse56) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse56) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse56(val *ApiResponse56) *NullableApiResponse56 {
	return &NullableApiResponse56{value: val, isSet: true}
}

func (v NullableApiResponse56) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse56) UnmarshalJSON(src []byte) error {
	v.isSet = true
