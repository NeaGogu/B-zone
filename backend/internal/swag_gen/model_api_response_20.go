...
// ApiResponse20 struct for ApiResponse20
type ApiResponse20 struct {
...
func (o ApiResponse20) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse20 struct {
	value *ApiResponse20
	isSet bool
}

func (v NullableApiResponse20) Get() *ApiResponse20 {
	return v.value
}

func (v *NullableApiResponse20) Set(val *ApiResponse20) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse20) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse20) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse20(val *ApiResponse20) *NullableApiResponse20 {
	return &NullableApiResponse20{value: val, isSet: true}
}

func (v NullableApiResponse20) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse20) UnmarshalJSON(src []byte) error {
	v.isSet = true
