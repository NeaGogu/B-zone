...
// ApiResponse2 struct for ApiResponse2
...
func (o ApiResponse2) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse2 struct {
	value *ApiResponse2
	isSet bool
}

func (v NullableApiResponse2) Get() *ApiResponse2 {
	return v.value
}

func (v *NullableApiResponse2) Set(val *ApiResponse2) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse2) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse2(val *ApiResponse2) *NullableApiResponse2 {
	return &NullableApiResponse2{value: val, isSet: true}
}

func (v NullableApiResponse2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse2) UnmarshalJSON(src []byte) error {
	v.isSet = true
