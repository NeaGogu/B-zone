...
// UserNotificationListResponse struct for UserNotificationListResponse
type UserNotificationListResponse struct {
	// 
	Items *[]UserNotificationModel `json:"items,omitempty"`
...
func NewUserNotificationListResponse() *UserNotificationListResponse {
	this := UserNotificationListResponse{}
	return &this
}
...
// SetItems gets a reference to the given []UserNotificationModel and assigns it to the Items field.
...
func (o UserNotificationListResponse) MarshalJSON() ([]byte, error) {
...
type NullableUserNotificationListResponse struct {
	value *UserNotificationListResponse
	isSet bool
}

func (v NullableUserNotificationListResponse) Get() *UserNotificationListResponse {
	return v.value
}

func (v *NullableUserNotificationListResponse) Set(val *UserNotificationListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUserNotificationListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUserNotificationListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserNotificationListResponse(val *UserNotificationListResponse) *NullableUserNotificationListResponse {
	return &NullableUserNotificationListResponse{value: val, isSet: true}
}

func (v NullableUserNotificationListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserNotificationListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
