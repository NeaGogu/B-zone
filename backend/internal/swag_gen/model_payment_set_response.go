...
// PaymentSetResponse struct for PaymentSetResponse
type PaymentSetResponse struct {
	// 
...
func (o PaymentSetResponse) MarshalJSON() ([]byte, error) {
...
type NullablePaymentSetResponse struct {
	value *PaymentSetResponse
	isSet bool
}

func (v NullablePaymentSetResponse) Get() *PaymentSetResponse {
	return v.value
}

func (v *NullablePaymentSetResponse) Set(val *PaymentSetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentSetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentSetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentSetResponse(val *PaymentSetResponse) *NullablePaymentSetResponse {
	return &NullablePaymentSetResponse{value: val, isSet: true}
}

func (v NullablePaymentSetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentSetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
