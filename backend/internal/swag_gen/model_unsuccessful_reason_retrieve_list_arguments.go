...
// UnsuccessfulReasonRetrieveListArguments struct for UnsuccessfulReasonRetrieveListArguments
type UnsuccessfulReasonRetrieveListArguments struct {
	Options *map[string]interface{} `json:"options,omitempty"`
	Filters *UnsuccessfulReasonFiltersModel `json:"filters,omitempty"`
	// 
...
func NewUnsuccessfulReasonRetrieveListArguments() *UnsuccessfulReasonRetrieveListArguments {
	this := UnsuccessfulReasonRetrieveListArguments{}
	return &this
}
...
func (o *UnsuccessfulReasonRetrieveListArguments) GetFilters() UnsuccessfulReasonFiltersModel {
	if o == nil || o.Filters == nil {
		var ret UnsuccessfulReasonFiltersModel
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given UnsuccessfulReasonFiltersModel and assigns it to the Filters field.
...
func (o UnsuccessfulReasonRetrieveListArguments) MarshalJSON() ([]byte, error) {
...
type NullableUnsuccessfulReasonRetrieveListArguments struct {
	value *UnsuccessfulReasonRetrieveListArguments
	isSet bool
}

func (v NullableUnsuccessfulReasonRetrieveListArguments) Get() *UnsuccessfulReasonRetrieveListArguments {
	return v.value
}

func (v *NullableUnsuccessfulReasonRetrieveListArguments) Set(val *UnsuccessfulReasonRetrieveListArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableUnsuccessfulReasonRetrieveListArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableUnsuccessfulReasonRetrieveListArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnsuccessfulReasonRetrieveListArguments(val *UnsuccessfulReasonRetrieveListArguments) *NullableUnsuccessfulReasonRetrieveListArguments {
	return &NullableUnsuccessfulReasonRetrieveListArguments{value: val, isSet: true}
}

func (v NullableUnsuccessfulReasonRetrieveListArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnsuccessfulReasonRetrieveListArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
