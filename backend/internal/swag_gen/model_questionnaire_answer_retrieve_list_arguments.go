...
// QuestionnaireAnswerRetrieveListArguments struct for QuestionnaireAnswerRetrieveListArguments
type QuestionnaireAnswerRetrieveListArguments struct {
	Options *QuestionnaireAnswerOptionsModel `json:"options,omitempty"`
	Filters *QuestionnaireAnswerFiltersModel `json:"filters,omitempty"`
	// 
...
func NewQuestionnaireAnswerRetrieveListArguments() *QuestionnaireAnswerRetrieveListArguments {
	this := QuestionnaireAnswerRetrieveListArguments{}
	return &this
}
...
func (o *QuestionnaireAnswerRetrieveListArguments) GetOptions() QuestionnaireAnswerOptionsModel {
	if o == nil || o.Options == nil {
		var ret QuestionnaireAnswerOptionsModel
		return ret
	}
	return *o.Options
}
...
// SetOptions gets a reference to the given QuestionnaireAnswerOptionsModel and assigns it to the Options field.
...
func (o *QuestionnaireAnswerRetrieveListArguments) GetFilters() QuestionnaireAnswerFiltersModel {
	if o == nil || o.Filters == nil {
		var ret QuestionnaireAnswerFiltersModel
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given QuestionnaireAnswerFiltersModel and assigns it to the Filters field.
...
func (o QuestionnaireAnswerRetrieveListArguments) MarshalJSON() ([]byte, error) {
...
type NullableQuestionnaireAnswerRetrieveListArguments struct {
	value *QuestionnaireAnswerRetrieveListArguments
	isSet bool
}

func (v NullableQuestionnaireAnswerRetrieveListArguments) Get() *QuestionnaireAnswerRetrieveListArguments {
	return v.value
}

func (v *NullableQuestionnaireAnswerRetrieveListArguments) Set(val *QuestionnaireAnswerRetrieveListArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableQuestionnaireAnswerRetrieveListArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableQuestionnaireAnswerRetrieveListArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuestionnaireAnswerRetrieveListArguments(val *QuestionnaireAnswerRetrieveListArguments) *NullableQuestionnaireAnswerRetrieveListArguments {
	return &NullableQuestionnaireAnswerRetrieveListArguments{value: val, isSet: true}
}

func (v NullableQuestionnaireAnswerRetrieveListArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuestionnaireAnswerRetrieveListArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
