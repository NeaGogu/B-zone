...
// ApiResponse53 struct for ApiResponse53
type ApiResponse53 struct {
...
func (o ApiResponse53) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse53 struct {
	value *ApiResponse53
	isSet bool
}

func (v NullableApiResponse53) Get() *ApiResponse53 {
	return v.value
}

func (v *NullableApiResponse53) Set(val *ApiResponse53) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse53) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse53) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse53(val *ApiResponse53) *NullableApiResponse53 {
	return &NullableApiResponse53{value: val, isSet: true}
}

func (v NullableApiResponse53) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse53) UnmarshalJSON(src []byte) error {
	v.isSet = true
