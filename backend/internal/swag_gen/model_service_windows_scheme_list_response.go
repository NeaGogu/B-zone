...
// ServiceWindowsSchemeListResponse struct for ServiceWindowsSchemeListResponse
type ServiceWindowsSchemeListResponse struct {
	// 
	Items *[]ServiceWindowsSchemeModel `json:"items,omitempty"`
...
func NewServiceWindowsSchemeListResponse() *ServiceWindowsSchemeListResponse {
	this := ServiceWindowsSchemeListResponse{}
	return &this
}
...
func (o *ServiceWindowsSchemeListResponse) GetItems() []ServiceWindowsSchemeModel {
	if o == nil || o.Items == nil {
		var ret []ServiceWindowsSchemeModel
		return ret
	}
	return *o.Items
}
...
// SetItems gets a reference to the given []ServiceWindowsSchemeModel and assigns it to the Items field.
...
func (o ServiceWindowsSchemeListResponse) MarshalJSON() ([]byte, error) {
...
type NullableServiceWindowsSchemeListResponse struct {
	value *ServiceWindowsSchemeListResponse
	isSet bool
}

func (v NullableServiceWindowsSchemeListResponse) Get() *ServiceWindowsSchemeListResponse {
	return v.value
}

func (v *NullableServiceWindowsSchemeListResponse) Set(val *ServiceWindowsSchemeListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceWindowsSchemeListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceWindowsSchemeListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceWindowsSchemeListResponse(val *ServiceWindowsSchemeListResponse) *NullableServiceWindowsSchemeListResponse {
	return &NullableServiceWindowsSchemeListResponse{value: val, isSet: true}
}

func (v NullableServiceWindowsSchemeListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceWindowsSchemeListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
