...
// ApiResponse23 struct for ApiResponse23
type ApiResponse23 struct {
...
func (o ApiResponse23) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse23 struct {
	value *ApiResponse23
	isSet bool
}

func (v NullableApiResponse23) Get() *ApiResponse23 {
	return v.value
}

func (v *NullableApiResponse23) Set(val *ApiResponse23) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse23) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse23) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse23(val *ApiResponse23) *NullableApiResponse23 {
	return &NullableApiResponse23{value: val, isSet: true}
}

func (v NullableApiResponse23) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse23) UnmarshalJSON(src []byte) error {
	v.isSet = true
