...
// TransactionUpdateResponse struct for TransactionUpdateResponse
...
func NewTransactionUpdateResponse() *TransactionUpdateResponse {
	this := TransactionUpdateResponse{}
	return &this
}
...
func (o TransactionUpdateResponse) MarshalJSON() ([]byte, error) {
...
type NullableTransactionUpdateResponse struct {
	value *TransactionUpdateResponse
	isSet bool
}

func (v NullableTransactionUpdateResponse) Get() *TransactionUpdateResponse {
	return v.value
}

func (v *NullableTransactionUpdateResponse) Set(val *TransactionUpdateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionUpdateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionUpdateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionUpdateResponse(val *TransactionUpdateResponse) *NullableTransactionUpdateResponse {
	return &NullableTransactionUpdateResponse{value: val, isSet: true}
}

func (v NullableTransactionUpdateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionUpdateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
