...
// QuestionnaireTemplateListResponse struct for QuestionnaireTemplateListResponse
type QuestionnaireTemplateListResponse struct {
	// 
	Items *[]QuestionnaireTemplateModel `json:"items,omitempty"`
...
func NewQuestionnaireTemplateListResponse() *QuestionnaireTemplateListResponse {
	this := QuestionnaireTemplateListResponse{}
	return &this
}
...
func (o *QuestionnaireTemplateListResponse) GetItems() []QuestionnaireTemplateModel {
	if o == nil || o.Items == nil {
		var ret []QuestionnaireTemplateModel
		return ret
	}
	return *o.Items
}
...
// SetItems gets a reference to the given []QuestionnaireTemplateModel and assigns it to the Items field.
...
func (o QuestionnaireTemplateListResponse) MarshalJSON() ([]byte, error) {
...
type NullableQuestionnaireTemplateListResponse struct {
	value *QuestionnaireTemplateListResponse
	isSet bool
}

func (v NullableQuestionnaireTemplateListResponse) Get() *QuestionnaireTemplateListResponse {
	return v.value
}

func (v *NullableQuestionnaireTemplateListResponse) Set(val *QuestionnaireTemplateListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableQuestionnaireTemplateListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableQuestionnaireTemplateListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuestionnaireTemplateListResponse(val *QuestionnaireTemplateListResponse) *NullableQuestionnaireTemplateListResponse {
	return &NullableQuestionnaireTemplateListResponse{value: val, isSet: true}
}

func (v NullableQuestionnaireTemplateListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuestionnaireTemplateListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
