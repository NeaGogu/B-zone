...
// VehicleTypeSetResponse struct for VehicleTypeSetResponse
type VehicleTypeSetResponse struct {
	// 
...
func (o VehicleTypeSetResponse) MarshalJSON() ([]byte, error) {
...
type NullableVehicleTypeSetResponse struct {
	value *VehicleTypeSetResponse
	isSet bool
}

func (v NullableVehicleTypeSetResponse) Get() *VehicleTypeSetResponse {
	return v.value
}

func (v *NullableVehicleTypeSetResponse) Set(val *VehicleTypeSetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVehicleTypeSetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVehicleTypeSetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVehicleTypeSetResponse(val *VehicleTypeSetResponse) *NullableVehicleTypeSetResponse {
	return &NullableVehicleTypeSetResponse{value: val, isSet: true}
}

func (v NullableVehicleTypeSetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVehicleTypeSetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
