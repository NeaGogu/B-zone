...
// ApiResponse34 struct for ApiResponse34
type ApiResponse34 struct {
...
func (o ApiResponse34) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse34 struct {
	value *ApiResponse34
	isSet bool
}

func (v NullableApiResponse34) Get() *ApiResponse34 {
	return v.value
}

func (v *NullableApiResponse34) Set(val *ApiResponse34) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse34) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse34) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse34(val *ApiResponse34) *NullableApiResponse34 {
	return &NullableApiResponse34{value: val, isSet: true}
}

func (v NullableApiResponse34) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse34) UnmarshalJSON(src []byte) error {
	v.isSet = true
