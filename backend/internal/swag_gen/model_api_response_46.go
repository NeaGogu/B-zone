...
// ApiResponse46 struct for ApiResponse46
type ApiResponse46 struct {
...
func (o ApiResponse46) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse46 struct {
	value *ApiResponse46
	isSet bool
}

func (v NullableApiResponse46) Get() *ApiResponse46 {
	return v.value
}

func (v *NullableApiResponse46) Set(val *ApiResponse46) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse46) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse46) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse46(val *ApiResponse46) *NullableApiResponse46 {
	return &NullableApiResponse46{value: val, isSet: true}
}

func (v NullableApiResponse46) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse46) UnmarshalJSON(src []byte) error {
	v.isSet = true
