...
// TransactionSetResponse struct for TransactionSetResponse
...
func (o TransactionSetResponse) MarshalJSON() ([]byte, error) {
...
type NullableTransactionSetResponse struct {
	value *TransactionSetResponse
	isSet bool
}

func (v NullableTransactionSetResponse) Get() *TransactionSetResponse {
	return v.value
}

func (v *NullableTransactionSetResponse) Set(val *TransactionSetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionSetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionSetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionSetResponse(val *TransactionSetResponse) *NullableTransactionSetResponse {
	return &NullableTransactionSetResponse{value: val, isSet: true}
}

func (v NullableTransactionSetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionSetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
