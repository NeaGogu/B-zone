...
// ApiResponse17 struct for ApiResponse17
type ApiResponse17 struct {
...
func (o ApiResponse17) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse17 struct {
	value *ApiResponse17
	isSet bool
}

func (v NullableApiResponse17) Get() *ApiResponse17 {
	return v.value
}

func (v *NullableApiResponse17) Set(val *ApiResponse17) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse17) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse17) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse17(val *ApiResponse17) *NullableApiResponse17 {
	return &NullableApiResponse17{value: val, isSet: true}
}

func (v NullableApiResponse17) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse17) UnmarshalJSON(src []byte) error {
	v.isSet = true
