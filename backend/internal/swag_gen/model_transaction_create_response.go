...
// TransactionCreateResponse struct for TransactionCreateResponse
...
func NewTransactionCreateResponse() *TransactionCreateResponse {
	this := TransactionCreateResponse{}
	return &this
}
...
func (o TransactionCreateResponse) MarshalJSON() ([]byte, error) {
...
type NullableTransactionCreateResponse struct {
	value *TransactionCreateResponse
	isSet bool
}

func (v NullableTransactionCreateResponse) Get() *TransactionCreateResponse {
	return v.value
}

func (v *NullableTransactionCreateResponse) Set(val *TransactionCreateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionCreateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionCreateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionCreateResponse(val *TransactionCreateResponse) *NullableTransactionCreateResponse {
	return &NullableTransactionCreateResponse{value: val, isSet: true}
}

func (v NullableTransactionCreateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionCreateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
