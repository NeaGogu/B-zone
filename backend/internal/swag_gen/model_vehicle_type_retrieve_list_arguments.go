...
// VehicleTypeRetrieveListArguments struct for VehicleTypeRetrieveListArguments
type VehicleTypeRetrieveListArguments struct {
	Options *map[string]interface{} `json:"options,omitempty"`
	Filters *VehicleTypeFiltersModel `json:"filters,omitempty"`
	// 
...
func NewVehicleTypeRetrieveListArguments() *VehicleTypeRetrieveListArguments {
	this := VehicleTypeRetrieveListArguments{}
	return &this
}
...
func (o *VehicleTypeRetrieveListArguments) GetFilters() VehicleTypeFiltersModel {
	if o == nil || o.Filters == nil {
		var ret VehicleTypeFiltersModel
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given VehicleTypeFiltersModel and assigns it to the Filters field.
...
func (o VehicleTypeRetrieveListArguments) MarshalJSON() ([]byte, error) {
...
type NullableVehicleTypeRetrieveListArguments struct {
	value *VehicleTypeRetrieveListArguments
	isSet bool
}

func (v NullableVehicleTypeRetrieveListArguments) Get() *VehicleTypeRetrieveListArguments {
	return v.value
}

func (v *NullableVehicleTypeRetrieveListArguments) Set(val *VehicleTypeRetrieveListArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableVehicleTypeRetrieveListArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableVehicleTypeRetrieveListArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVehicleTypeRetrieveListArguments(val *VehicleTypeRetrieveListArguments) *NullableVehicleTypeRetrieveListArguments {
	return &NullableVehicleTypeRetrieveListArguments{value: val, isSet: true}
}

func (v NullableVehicleTypeRetrieveListArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVehicleTypeRetrieveListArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
