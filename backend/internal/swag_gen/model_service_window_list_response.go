...
// ServiceWindowListResponse struct for ServiceWindowListResponse
type ServiceWindowListResponse struct {
	// 
	Items *[]ServiceWindowModel `json:"items,omitempty"`
...
func NewServiceWindowListResponse() *ServiceWindowListResponse {
	this := ServiceWindowListResponse{}
	return &this
}
...
// SetItems gets a reference to the given []ServiceWindowModel and assigns it to the Items field.
...
func (o ServiceWindowListResponse) MarshalJSON() ([]byte, error) {
...
type NullableServiceWindowListResponse struct {
	value *ServiceWindowListResponse
	isSet bool
}

func (v NullableServiceWindowListResponse) Get() *ServiceWindowListResponse {
	return v.value
}

func (v *NullableServiceWindowListResponse) Set(val *ServiceWindowListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceWindowListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceWindowListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceWindowListResponse(val *ServiceWindowListResponse) *NullableServiceWindowListResponse {
	return &NullableServiceWindowListResponse{value: val, isSet: true}
}

func (v NullableServiceWindowListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceWindowListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
