...
// ApiResponse27 struct for ApiResponse27
type ApiResponse27 struct {
...
func (o ApiResponse27) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse27 struct {
	value *ApiResponse27
	isSet bool
}

func (v NullableApiResponse27) Get() *ApiResponse27 {
	return v.value
}

func (v *NullableApiResponse27) Set(val *ApiResponse27) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse27) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse27) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse27(val *ApiResponse27) *NullableApiResponse27 {
	return &NullableApiResponse27{value: val, isSet: true}
}

func (v NullableApiResponse27) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse27) UnmarshalJSON(src []byte) error {
	v.isSet = true
