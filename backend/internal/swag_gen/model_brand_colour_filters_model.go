...
// BrandColourFiltersModel struct for BrandColourFiltersModel
type BrandColourFiltersModel struct {
	// BrandColour id's
	Id *[]int32 `json:"id,omitempty"`
	// BrandColour Link ids
...
func (o BrandColourFiltersModel) MarshalJSON() ([]byte, error) {
...
type NullableBrandColourFiltersModel struct {
	value *BrandColourFiltersModel
	isSet bool
}

func (v NullableBrandColourFiltersModel) Get() *BrandColourFiltersModel {
	return v.value
}

func (v *NullableBrandColourFiltersModel) Set(val *BrandColourFiltersModel) {
	v.value = val
	v.isSet = true
}

func (v NullableBrandColourFiltersModel) IsSet() bool {
	return v.isSet
}

func (v *NullableBrandColourFiltersModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBrandColourFiltersModel(val *BrandColourFiltersModel) *NullableBrandColourFiltersModel {
	return &NullableBrandColourFiltersModel{value: val, isSet: true}
}

func (v NullableBrandColourFiltersModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBrandColourFiltersModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
