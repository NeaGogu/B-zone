...
// PaymentUpdateResponse struct for PaymentUpdateResponse
...
func (o PaymentUpdateResponse) MarshalJSON() ([]byte, error) {
...
type NullablePaymentUpdateResponse struct {
	value *PaymentUpdateResponse
	isSet bool
}

func (v NullablePaymentUpdateResponse) Get() *PaymentUpdateResponse {
	return v.value
}

func (v *NullablePaymentUpdateResponse) Set(val *PaymentUpdateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentUpdateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentUpdateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentUpdateResponse(val *PaymentUpdateResponse) *NullablePaymentUpdateResponse {
	return &NullablePaymentUpdateResponse{value: val, isSet: true}
}

func (v NullablePaymentUpdateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentUpdateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
