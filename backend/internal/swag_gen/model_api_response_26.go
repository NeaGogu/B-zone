...
// ApiResponse26 struct for ApiResponse26
type ApiResponse26 struct {
...
func (o ApiResponse26) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse26 struct {
	value *ApiResponse26
	isSet bool
}

func (v NullableApiResponse26) Get() *ApiResponse26 {
	return v.value
}

func (v *NullableApiResponse26) Set(val *ApiResponse26) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse26) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse26) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse26(val *ApiResponse26) *NullableApiResponse26 {
	return &NullableApiResponse26{value: val, isSet: true}
}

func (v NullableApiResponse26) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse26) UnmarshalJSON(src []byte) error {
	v.isSet = true
