...
// NotificationCategoryRetrieveListArguments struct for NotificationCategoryRetrieveListArguments
type NotificationCategoryRetrieveListArguments struct {
	Options *NotificationCategoryOptionsModel `json:"options,omitempty"`
	Filters *NotificationCategoryFiltersModel `json:"filters,omitempty"`
	// 
...
func NewNotificationCategoryRetrieveListArguments() *NotificationCategoryRetrieveListArguments {
	this := NotificationCategoryRetrieveListArguments{}
	return &this
}
...
func (o *NotificationCategoryRetrieveListArguments) GetOptions() NotificationCategoryOptionsModel {
	if o == nil || o.Options == nil {
		var ret NotificationCategoryOptionsModel
		return ret
	}
	return *o.Options
}
...
// SetOptions gets a reference to the given NotificationCategoryOptionsModel and assigns it to the Options field.
...
func (o *NotificationCategoryRetrieveListArguments) GetFilters() NotificationCategoryFiltersModel {
	if o == nil || o.Filters == nil {
		var ret NotificationCategoryFiltersModel
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given NotificationCategoryFiltersModel and assigns it to the Filters field.
...
func (o NotificationCategoryRetrieveListArguments) MarshalJSON() ([]byte, error) {
...
type NullableNotificationCategoryRetrieveListArguments struct {
	value *NotificationCategoryRetrieveListArguments
	isSet bool
}

func (v NullableNotificationCategoryRetrieveListArguments) Get() *NotificationCategoryRetrieveListArguments {
	return v.value
}

func (v *NullableNotificationCategoryRetrieveListArguments) Set(val *NotificationCategoryRetrieveListArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationCategoryRetrieveListArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationCategoryRetrieveListArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationCategoryRetrieveListArguments(val *NotificationCategoryRetrieveListArguments) *NullableNotificationCategoryRetrieveListArguments {
	return &NullableNotificationCategoryRetrieveListArguments{value: val, isSet: true}
}

func (v NullableNotificationCategoryRetrieveListArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationCategoryRetrieveListArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
