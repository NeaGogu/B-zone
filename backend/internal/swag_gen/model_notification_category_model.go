...
// NotificationCategoryModel struct for NotificationCategoryModel
type NotificationCategoryModel struct {
	// Unique ID
	Id *int64 `json:"id,omitempty"`
	// The name of the NotificationCategory field
...
func NewNotificationCategoryModel() *NotificationCategoryModel {
	this := NotificationCategoryModel{}
	return &this
}
...
func (o NotificationCategoryModel) MarshalJSON() ([]byte, error) {
...
type NullableNotificationCategoryModel struct {
	value *NotificationCategoryModel
	isSet bool
}

func (v NullableNotificationCategoryModel) Get() *NotificationCategoryModel {
	return v.value
}

func (v *NullableNotificationCategoryModel) Set(val *NotificationCategoryModel) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationCategoryModel) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationCategoryModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationCategoryModel(val *NotificationCategoryModel) *NullableNotificationCategoryModel {
	return &NullableNotificationCategoryModel{value: val, isSet: true}
}

func (v NullableNotificationCategoryModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationCategoryModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
