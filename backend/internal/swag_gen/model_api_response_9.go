...
// ApiResponse9 struct for ApiResponse9
type ApiResponse9 struct {
...
func (o ApiResponse9) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse9 struct {
	value *ApiResponse9
	isSet bool
}

func (v NullableApiResponse9) Get() *ApiResponse9 {
	return v.value
}

func (v *NullableApiResponse9) Set(val *ApiResponse9) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse9) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse9) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse9(val *ApiResponse9) *NullableApiResponse9 {
	return &NullableApiResponse9{value: val, isSet: true}
}

func (v NullableApiResponse9) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse9) UnmarshalJSON(src []byte) error {
	v.isSet = true
