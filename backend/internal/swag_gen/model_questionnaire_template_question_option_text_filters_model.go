...
// QuestionnaireTemplateQuestionOptionTextFiltersModel struct for QuestionnaireTemplateQuestionOptionTextFiltersModel
type QuestionnaireTemplateQuestionOptionTextFiltersModel struct {
	// QuestionnaireTemplateQuestionOptionText id's
...
func NewQuestionnaireTemplateQuestionOptionTextFiltersModel() *QuestionnaireTemplateQuestionOptionTextFiltersModel {
	this := QuestionnaireTemplateQuestionOptionTextFiltersModel{}
	return &this
}
...
func (o QuestionnaireTemplateQuestionOptionTextFiltersModel) MarshalJSON() ([]byte, error) {
...
type NullableQuestionnaireTemplateQuestionOptionTextFiltersModel struct {
	value *QuestionnaireTemplateQuestionOptionTextFiltersModel
	isSet bool
}

func (v NullableQuestionnaireTemplateQuestionOptionTextFiltersModel) Get() *QuestionnaireTemplateQuestionOptionTextFiltersModel {
	return v.value
}

func (v *NullableQuestionnaireTemplateQuestionOptionTextFiltersModel) Set(val *QuestionnaireTemplateQuestionOptionTextFiltersModel) {
	v.value = val
	v.isSet = true
}

func (v NullableQuestionnaireTemplateQuestionOptionTextFiltersModel) IsSet() bool {
	return v.isSet
}

func (v *NullableQuestionnaireTemplateQuestionOptionTextFiltersModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuestionnaireTemplateQuestionOptionTextFiltersModel(val *QuestionnaireTemplateQuestionOptionTextFiltersModel) *NullableQuestionnaireTemplateQuestionOptionTextFiltersModel {
	return &NullableQuestionnaireTemplateQuestionOptionTextFiltersModel{value: val, isSet: true}
}

func (v NullableQuestionnaireTemplateQuestionOptionTextFiltersModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuestionnaireTemplateQuestionOptionTextFiltersModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
