...
// ApiResponse1 struct for ApiResponse1
...
func (o ApiResponse1) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse1 struct {
	value *ApiResponse1
	isSet bool
}

func (v NullableApiResponse1) Get() *ApiResponse1 {
	return v.value
}

func (v *NullableApiResponse1) Set(val *ApiResponse1) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse1) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse1(val *ApiResponse1) *NullableApiResponse1 {
	return &NullableApiResponse1{value: val, isSet: true}
}

func (v NullableApiResponse1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse1) UnmarshalJSON(src []byte) error {
	v.isSet = true
