...
// QuestionnaireTemplateQuestionOptionTextRetrieveListArguments struct for QuestionnaireTemplateQuestionOptionTextRetrieveListArguments
type QuestionnaireTemplateQuestionOptionTextRetrieveListArguments struct {
	Options *map[string]interface{} `json:"options,omitempty"`
	Filters *QuestionnaireTemplateQuestionOptionTextFiltersModel `json:"filters,omitempty"`
	// 
...
func NewQuestionnaireTemplateQuestionOptionTextRetrieveListArguments() *QuestionnaireTemplateQuestionOptionTextRetrieveListArguments {
	this := QuestionnaireTemplateQuestionOptionTextRetrieveListArguments{}
	return &this
}
...
func (o *QuestionnaireTemplateQuestionOptionTextRetrieveListArguments) GetFilters() QuestionnaireTemplateQuestionOptionTextFiltersModel {
	if o == nil || o.Filters == nil {
		var ret QuestionnaireTemplateQuestionOptionTextFiltersModel
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given QuestionnaireTemplateQuestionOptionTextFiltersModel and assigns it to the Filters field.
...
func (o QuestionnaireTemplateQuestionOptionTextRetrieveListArguments) MarshalJSON() ([]byte, error) {
...
type NullableQuestionnaireTemplateQuestionOptionTextRetrieveListArguments struct {
	value *QuestionnaireTemplateQuestionOptionTextRetrieveListArguments
	isSet bool
}

func (v NullableQuestionnaireTemplateQuestionOptionTextRetrieveListArguments) Get() *QuestionnaireTemplateQuestionOptionTextRetrieveListArguments {
	return v.value
}

func (v *NullableQuestionnaireTemplateQuestionOptionTextRetrieveListArguments) Set(val *QuestionnaireTemplateQuestionOptionTextRetrieveListArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableQuestionnaireTemplateQuestionOptionTextRetrieveListArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableQuestionnaireTemplateQuestionOptionTextRetrieveListArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuestionnaireTemplateQuestionOptionTextRetrieveListArguments(val *QuestionnaireTemplateQuestionOptionTextRetrieveListArguments) *NullableQuestionnaireTemplateQuestionOptionTextRetrieveListArguments {
	return &NullableQuestionnaireTemplateQuestionOptionTextRetrieveListArguments{value: val, isSet: true}
}

func (v NullableQuestionnaireTemplateQuestionOptionTextRetrieveListArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuestionnaireTemplateQuestionOptionTextRetrieveListArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
