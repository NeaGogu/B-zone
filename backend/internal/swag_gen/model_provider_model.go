...
// ProviderModel struct for ProviderModel
...
func (o ProviderModel) MarshalJSON() ([]byte, error) {
...
type NullableProviderModel struct {
	value *ProviderModel
	isSet bool
}

func (v NullableProviderModel) Get() *ProviderModel {
	return v.value
}

func (v *NullableProviderModel) Set(val *ProviderModel) {
	v.value = val
	v.isSet = true
}

func (v NullableProviderModel) IsSet() bool {
	return v.isSet
}

func (v *NullableProviderModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProviderModel(val *ProviderModel) *NullableProviderModel {
	return &NullableProviderModel{value: val, isSet: true}
}

func (v NullableProviderModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProviderModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
