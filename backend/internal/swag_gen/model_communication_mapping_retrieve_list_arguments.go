...
// CommunicationMappingRetrieveListArguments struct for CommunicationMappingRetrieveListArguments
type CommunicationMappingRetrieveListArguments struct {
	Options *CommunicationMappingOptionsModel `json:"options,omitempty"`
	Filters *CommunicationMappingFiltersModel `json:"filters,omitempty"`
	// Sorting Column
...
func NewCommunicationMappingRetrieveListArguments() *CommunicationMappingRetrieveListArguments {
	this := CommunicationMappingRetrieveListArguments{}
	return &this
}
...
func (o *CommunicationMappingRetrieveListArguments) GetOptions() CommunicationMappingOptionsModel {
	if o == nil || o.Options == nil {
		var ret CommunicationMappingOptionsModel
		return ret
	}
	return *o.Options
}
...
// SetOptions gets a reference to the given CommunicationMappingOptionsModel and assigns it to the Options field.
...
func (o *CommunicationMappingRetrieveListArguments) GetFilters() CommunicationMappingFiltersModel {
	if o == nil || o.Filters == nil {
		var ret CommunicationMappingFiltersModel
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given CommunicationMappingFiltersModel and assigns it to the Filters field.
...
func (o CommunicationMappingRetrieveListArguments) MarshalJSON() ([]byte, error) {
...
type NullableCommunicationMappingRetrieveListArguments struct {
	value *CommunicationMappingRetrieveListArguments
	isSet bool
}

func (v NullableCommunicationMappingRetrieveListArguments) Get() *CommunicationMappingRetrieveListArguments {
	return v.value
}

func (v *NullableCommunicationMappingRetrieveListArguments) Set(val *CommunicationMappingRetrieveListArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableCommunicationMappingRetrieveListArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableCommunicationMappingRetrieveListArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommunicationMappingRetrieveListArguments(val *CommunicationMappingRetrieveListArguments) *NullableCommunicationMappingRetrieveListArguments {
	return &NullableCommunicationMappingRetrieveListArguments{value: val, isSet: true}
}

func (v NullableCommunicationMappingRetrieveListArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommunicationMappingRetrieveListArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
