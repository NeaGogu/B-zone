...
// QuestionnaireTemplateQuestionListResponse struct for QuestionnaireTemplateQuestionListResponse
type QuestionnaireTemplateQuestionListResponse struct {
	// 
	Items *[]QuestionnaireTemplateQuestionModel `json:"items,omitempty"`
...
func NewQuestionnaireTemplateQuestionListResponse() *QuestionnaireTemplateQuestionListResponse {
	this := QuestionnaireTemplateQuestionListResponse{}
	return &this
}
...
// SetItems gets a reference to the given []QuestionnaireTemplateQuestionModel and assigns it to the Items field.
...
func (o QuestionnaireTemplateQuestionListResponse) MarshalJSON() ([]byte, error) {
...
type NullableQuestionnaireTemplateQuestionListResponse struct {
	value *QuestionnaireTemplateQuestionListResponse
	isSet bool
}

func (v NullableQuestionnaireTemplateQuestionListResponse) Get() *QuestionnaireTemplateQuestionListResponse {
	return v.value
}

func (v *NullableQuestionnaireTemplateQuestionListResponse) Set(val *QuestionnaireTemplateQuestionListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableQuestionnaireTemplateQuestionListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableQuestionnaireTemplateQuestionListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuestionnaireTemplateQuestionListResponse(val *QuestionnaireTemplateQuestionListResponse) *NullableQuestionnaireTemplateQuestionListResponse {
	return &NullableQuestionnaireTemplateQuestionListResponse{value: val, isSet: true}
}

func (v NullableQuestionnaireTemplateQuestionListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuestionnaireTemplateQuestionListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
