...
// ApiResponse16 struct for ApiResponse16
type ApiResponse16 struct {
...
func (o ApiResponse16) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse16 struct {
	value *ApiResponse16
	isSet bool
}

func (v NullableApiResponse16) Get() *ApiResponse16 {
	return v.value
}

func (v *NullableApiResponse16) Set(val *ApiResponse16) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse16) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse16) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse16(val *ApiResponse16) *NullableApiResponse16 {
	return &NullableApiResponse16{value: val, isSet: true}
}

func (v NullableApiResponse16) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse16) UnmarshalJSON(src []byte) error {
	v.isSet = true
