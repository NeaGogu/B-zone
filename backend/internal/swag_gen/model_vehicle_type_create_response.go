...
// VehicleTypeCreateResponse struct for VehicleTypeCreateResponse
type VehicleTypeCreateResponse struct {
	// 
...
func NewVehicleTypeCreateResponse() *VehicleTypeCreateResponse {
	this := VehicleTypeCreateResponse{}
	return &this
}
...
func (o VehicleTypeCreateResponse) MarshalJSON() ([]byte, error) {
...
type NullableVehicleTypeCreateResponse struct {
	value *VehicleTypeCreateResponse
	isSet bool
}

func (v NullableVehicleTypeCreateResponse) Get() *VehicleTypeCreateResponse {
	return v.value
}

func (v *NullableVehicleTypeCreateResponse) Set(val *VehicleTypeCreateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVehicleTypeCreateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVehicleTypeCreateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVehicleTypeCreateResponse(val *VehicleTypeCreateResponse) *NullableVehicleTypeCreateResponse {
	return &NullableVehicleTypeCreateResponse{value: val, isSet: true}
}

func (v NullableVehicleTypeCreateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVehicleTypeCreateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
