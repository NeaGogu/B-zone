...
// VehicleTypeDeleteResponse struct for VehicleTypeDeleteResponse
type VehicleTypeDeleteResponse struct {
	// 
...
func NewVehicleTypeDeleteResponse() *VehicleTypeDeleteResponse {
	this := VehicleTypeDeleteResponse{}
	return &this
}
...
func (o VehicleTypeDeleteResponse) MarshalJSON() ([]byte, error) {
...
type NullableVehicleTypeDeleteResponse struct {
	value *VehicleTypeDeleteResponse
	isSet bool
}

func (v NullableVehicleTypeDeleteResponse) Get() *VehicleTypeDeleteResponse {
	return v.value
}

func (v *NullableVehicleTypeDeleteResponse) Set(val *VehicleTypeDeleteResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVehicleTypeDeleteResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVehicleTypeDeleteResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVehicleTypeDeleteResponse(val *VehicleTypeDeleteResponse) *NullableVehicleTypeDeleteResponse {
	return &NullableVehicleTypeDeleteResponse{value: val, isSet: true}
}

func (v NullableVehicleTypeDeleteResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVehicleTypeDeleteResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
