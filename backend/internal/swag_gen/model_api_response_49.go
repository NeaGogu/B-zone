...
// ApiResponse49 struct for ApiResponse49
type ApiResponse49 struct {
...
func (o ApiResponse49) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse49 struct {
	value *ApiResponse49
	isSet bool
}

func (v NullableApiResponse49) Get() *ApiResponse49 {
	return v.value
}

func (v *NullableApiResponse49) Set(val *ApiResponse49) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse49) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse49) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse49(val *ApiResponse49) *NullableApiResponse49 {
	return &NullableApiResponse49{value: val, isSet: true}
}

func (v NullableApiResponse49) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse49) UnmarshalJSON(src []byte) error {
	v.isSet = true
