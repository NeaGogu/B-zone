...
// ApiResponse40 struct for ApiResponse40
type ApiResponse40 struct {
...
func (o ApiResponse40) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse40 struct {
	value *ApiResponse40
	isSet bool
}

func (v NullableApiResponse40) Get() *ApiResponse40 {
	return v.value
}

func (v *NullableApiResponse40) Set(val *ApiResponse40) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse40) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse40) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse40(val *ApiResponse40) *NullableApiResponse40 {
	return &NullableApiResponse40{value: val, isSet: true}
}

func (v NullableApiResponse40) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse40) UnmarshalJSON(src []byte) error {
	v.isSet = true
