...
// ApiResponse14 struct for ApiResponse14
type ApiResponse14 struct {
...
func (o ApiResponse14) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse14 struct {
	value *ApiResponse14
	isSet bool
}

func (v NullableApiResponse14) Get() *ApiResponse14 {
	return v.value
}

func (v *NullableApiResponse14) Set(val *ApiResponse14) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse14) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse14(val *ApiResponse14) *NullableApiResponse14 {
	return &NullableApiResponse14{value: val, isSet: true}
}

func (v NullableApiResponse14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse14) UnmarshalJSON(src []byte) error {
	v.isSet = true
