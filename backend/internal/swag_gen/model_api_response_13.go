...
// ApiResponse13 struct for ApiResponse13
type ApiResponse13 struct {
...
func (o ApiResponse13) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse13 struct {
	value *ApiResponse13
	isSet bool
}

func (v NullableApiResponse13) Get() *ApiResponse13 {
	return v.value
}

func (v *NullableApiResponse13) Set(val *ApiResponse13) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse13) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse13) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse13(val *ApiResponse13) *NullableApiResponse13 {
	return &NullableApiResponse13{value: val, isSet: true}
}

func (v NullableApiResponse13) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse13) UnmarshalJSON(src []byte) error {
	v.isSet = true
