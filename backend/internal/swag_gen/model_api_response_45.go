...
// ApiResponse45 struct for ApiResponse45
type ApiResponse45 struct {
...
func (o ApiResponse45) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse45 struct {
	value *ApiResponse45
	isSet bool
}

func (v NullableApiResponse45) Get() *ApiResponse45 {
	return v.value
}

func (v *NullableApiResponse45) Set(val *ApiResponse45) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse45) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse45) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse45(val *ApiResponse45) *NullableApiResponse45 {
	return &NullableApiResponse45{value: val, isSet: true}
}

func (v NullableApiResponse45) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse45) UnmarshalJSON(src []byte) error {
	v.isSet = true
