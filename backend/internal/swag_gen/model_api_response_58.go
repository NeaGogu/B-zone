...
// ApiResponse58 struct for ApiResponse58
type ApiResponse58 struct {
...
func (o ApiResponse58) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse58 struct {
	value *ApiResponse58
	isSet bool
}

func (v NullableApiResponse58) Get() *ApiResponse58 {
	return v.value
}

func (v *NullableApiResponse58) Set(val *ApiResponse58) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse58) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse58) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse58(val *ApiResponse58) *NullableApiResponse58 {
	return &NullableApiResponse58{value: val, isSet: true}
}

func (v NullableApiResponse58) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse58) UnmarshalJSON(src []byte) error {
	v.isSet = true
