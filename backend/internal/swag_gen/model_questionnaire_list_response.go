...
// QuestionnaireListResponse struct for QuestionnaireListResponse
type QuestionnaireListResponse struct {
	// 
	Items *[]QuestionnaireModel `json:"items,omitempty"`
...
func NewQuestionnaireListResponse() *QuestionnaireListResponse {
	this := QuestionnaireListResponse{}
	return &this
}
...
// SetItems gets a reference to the given []QuestionnaireModel and assigns it to the Items field.
...
func (o QuestionnaireListResponse) MarshalJSON() ([]byte, error) {
...
type NullableQuestionnaireListResponse struct {
	value *QuestionnaireListResponse
	isSet bool
}

func (v NullableQuestionnaireListResponse) Get() *QuestionnaireListResponse {
	return v.value
}

func (v *NullableQuestionnaireListResponse) Set(val *QuestionnaireListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableQuestionnaireListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableQuestionnaireListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuestionnaireListResponse(val *QuestionnaireListResponse) *NullableQuestionnaireListResponse {
	return &NullableQuestionnaireListResponse{value: val, isSet: true}
}

func (v NullableQuestionnaireListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuestionnaireListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
