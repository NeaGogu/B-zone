...
// ApiResponse44 struct for ApiResponse44
type ApiResponse44 struct {
...
func (o ApiResponse44) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse44 struct {
	value *ApiResponse44
	isSet bool
}

func (v NullableApiResponse44) Get() *ApiResponse44 {
	return v.value
}

func (v *NullableApiResponse44) Set(val *ApiResponse44) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse44) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse44) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse44(val *ApiResponse44) *NullableApiResponse44 {
	return &NullableApiResponse44{value: val, isSet: true}
}

func (v NullableApiResponse44) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse44) UnmarshalJSON(src []byte) error {
	v.isSet = true
