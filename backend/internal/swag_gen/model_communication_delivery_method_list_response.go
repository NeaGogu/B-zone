...
// CommunicationDeliveryMethodListResponse struct for CommunicationDeliveryMethodListResponse
type CommunicationDeliveryMethodListResponse struct {
	// 
	Items *[]CommunicationDeliveryMethodModel `json:"items,omitempty"`
...
func NewCommunicationDeliveryMethodListResponse() *CommunicationDeliveryMethodListResponse {
	this := CommunicationDeliveryMethodListResponse{}
	return &this
}
...
func (o *CommunicationDeliveryMethodListResponse) GetItems() []CommunicationDeliveryMethodModel {
	if o == nil || o.Items == nil {
		var ret []CommunicationDeliveryMethodModel
		return ret
	}
	return *o.Items
}
...
// SetItems gets a reference to the given []CommunicationDeliveryMethodModel and assigns it to the Items field.
...
func (o CommunicationDeliveryMethodListResponse) MarshalJSON() ([]byte, error) {
...
type NullableCommunicationDeliveryMethodListResponse struct {
	value *CommunicationDeliveryMethodListResponse
	isSet bool
}

func (v NullableCommunicationDeliveryMethodListResponse) Get() *CommunicationDeliveryMethodListResponse {
	return v.value
}

func (v *NullableCommunicationDeliveryMethodListResponse) Set(val *CommunicationDeliveryMethodListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCommunicationDeliveryMethodListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCommunicationDeliveryMethodListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommunicationDeliveryMethodListResponse(val *CommunicationDeliveryMethodListResponse) *NullableCommunicationDeliveryMethodListResponse {
	return &NullableCommunicationDeliveryMethodListResponse{value: val, isSet: true}
}

func (v NullableCommunicationDeliveryMethodListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommunicationDeliveryMethodListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
