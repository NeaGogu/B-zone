...
// ApiResponse32 struct for ApiResponse32
type ApiResponse32 struct {
...
func (o ApiResponse32) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse32 struct {
	value *ApiResponse32
	isSet bool
}

func (v NullableApiResponse32) Get() *ApiResponse32 {
	return v.value
}

func (v *NullableApiResponse32) Set(val *ApiResponse32) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse32) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse32) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse32(val *ApiResponse32) *NullableApiResponse32 {
	return &NullableApiResponse32{value: val, isSet: true}
}

func (v NullableApiResponse32) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse32) UnmarshalJSON(src []byte) error {
	v.isSet = true
