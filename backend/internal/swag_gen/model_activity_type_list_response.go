...
// ActivityTypeListResponse struct for ActivityTypeListResponse
type ActivityTypeListResponse struct {
	// 
	Items *[]ActivityTypeModel `json:"items,omitempty"`
...
// SetItems gets a reference to the given []ActivityTypeModel and assigns it to the Items field.
...
func (o ActivityTypeListResponse) MarshalJSON() ([]byte, error) {
...
type NullableActivityTypeListResponse struct {
	value *ActivityTypeListResponse
	isSet bool
}

func (v NullableActivityTypeListResponse) Get() *ActivityTypeListResponse {
	return v.value
}

func (v *NullableActivityTypeListResponse) Set(val *ActivityTypeListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableActivityTypeListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableActivityTypeListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivityTypeListResponse(val *ActivityTypeListResponse) *NullableActivityTypeListResponse {
	return &NullableActivityTypeListResponse{value: val, isSet: true}
}

func (v NullableActivityTypeListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivityTypeListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
