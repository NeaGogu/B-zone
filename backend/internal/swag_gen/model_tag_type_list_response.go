...
// TagTypeListResponse struct for TagTypeListResponse
type TagTypeListResponse struct {
	// 
	Items *[]TagTypeModel `json:"items,omitempty"`
...
// SetItems gets a reference to the given []TagTypeModel and assigns it to the Items field.
...
func (o TagTypeListResponse) MarshalJSON() ([]byte, error) {
...
type NullableTagTypeListResponse struct {
	value *TagTypeListResponse
	isSet bool
}

func (v NullableTagTypeListResponse) Get() *TagTypeListResponse {
	return v.value
}

func (v *NullableTagTypeListResponse) Set(val *TagTypeListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTagTypeListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTagTypeListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagTypeListResponse(val *TagTypeListResponse) *NullableTagTypeListResponse {
	return &NullableTagTypeListResponse{value: val, isSet: true}
}

func (v NullableTagTypeListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagTypeListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
