...
// DriverListResponse struct for DriverListResponse
type DriverListResponse struct {
	// 
	Items *[]DriverModel `json:"items,omitempty"`
...
// SetItems gets a reference to the given []DriverModel and assigns it to the Items field.
...
func (o DriverListResponse) MarshalJSON() ([]byte, error) {
...
type NullableDriverListResponse struct {
	value *DriverListResponse
	isSet bool
}

func (v NullableDriverListResponse) Get() *DriverListResponse {
	return v.value
}

func (v *NullableDriverListResponse) Set(val *DriverListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDriverListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDriverListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDriverListResponse(val *DriverListResponse) *NullableDriverListResponse {
	return &NullableDriverListResponse{value: val, isSet: true}
}

func (v NullableDriverListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDriverListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
