...
// DriverUnavailabilityRetrieveListArguments struct for DriverUnavailabilityRetrieveListArguments
type DriverUnavailabilityRetrieveListArguments struct {
	Options *DriverUnavailabilityOptionsModel `json:"options,omitempty"`
	Filters *DriverUnavailabilityFiltersModel `json:"filters,omitempty"`
	// 
...
func NewDriverUnavailabilityRetrieveListArguments() *DriverUnavailabilityRetrieveListArguments {
	this := DriverUnavailabilityRetrieveListArguments{}
	return &this
}
...
func (o *DriverUnavailabilityRetrieveListArguments) GetOptions() DriverUnavailabilityOptionsModel {
	if o == nil || o.Options == nil {
		var ret DriverUnavailabilityOptionsModel
		return ret
	}
	return *o.Options
}
...
// SetOptions gets a reference to the given DriverUnavailabilityOptionsModel and assigns it to the Options field.
...
func (o *DriverUnavailabilityRetrieveListArguments) GetFilters() DriverUnavailabilityFiltersModel {
	if o == nil || o.Filters == nil {
		var ret DriverUnavailabilityFiltersModel
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given DriverUnavailabilityFiltersModel and assigns it to the Filters field.
...
func (o DriverUnavailabilityRetrieveListArguments) MarshalJSON() ([]byte, error) {
...
type NullableDriverUnavailabilityRetrieveListArguments struct {
	value *DriverUnavailabilityRetrieveListArguments
	isSet bool
}

func (v NullableDriverUnavailabilityRetrieveListArguments) Get() *DriverUnavailabilityRetrieveListArguments {
	return v.value
}

func (v *NullableDriverUnavailabilityRetrieveListArguments) Set(val *DriverUnavailabilityRetrieveListArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableDriverUnavailabilityRetrieveListArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableDriverUnavailabilityRetrieveListArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDriverUnavailabilityRetrieveListArguments(val *DriverUnavailabilityRetrieveListArguments) *NullableDriverUnavailabilityRetrieveListArguments {
	return &NullableDriverUnavailabilityRetrieveListArguments{value: val, isSet: true}
}

func (v NullableDriverUnavailabilityRetrieveListArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDriverUnavailabilityRetrieveListArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
