...
// PortalSettingListResponse struct for PortalSettingListResponse
type PortalSettingListResponse struct {
	// 
	Items *[]PortalSettingModel `json:"items,omitempty"`
...
func NewPortalSettingListResponse() *PortalSettingListResponse {
	this := PortalSettingListResponse{}
	return &this
}
...
// SetItems gets a reference to the given []PortalSettingModel and assigns it to the Items field.
...
func (o PortalSettingListResponse) MarshalJSON() ([]byte, error) {
...
type NullablePortalSettingListResponse struct {
	value *PortalSettingListResponse
	isSet bool
}

func (v NullablePortalSettingListResponse) Get() *PortalSettingListResponse {
	return v.value
}

func (v *NullablePortalSettingListResponse) Set(val *PortalSettingListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePortalSettingListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePortalSettingListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePortalSettingListResponse(val *PortalSettingListResponse) *NullablePortalSettingListResponse {
	return &NullablePortalSettingListResponse{value: val, isSet: true}
}

func (v NullablePortalSettingListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePortalSettingListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
