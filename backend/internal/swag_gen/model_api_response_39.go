...
// ApiResponse39 struct for ApiResponse39
type ApiResponse39 struct {
...
func (o ApiResponse39) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse39 struct {
	value *ApiResponse39
	isSet bool
}

func (v NullableApiResponse39) Get() *ApiResponse39 {
	return v.value
}

func (v *NullableApiResponse39) Set(val *ApiResponse39) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse39) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse39) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse39(val *ApiResponse39) *NullableApiResponse39 {
	return &NullableApiResponse39{value: val, isSet: true}
}

func (v NullableApiResponse39) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse39) UnmarshalJSON(src []byte) error {
	v.isSet = true
