...
// ApiResponse48 struct for ApiResponse48
type ApiResponse48 struct {
...
func (o ApiResponse48) MarshalJSON() ([]byte, error) {
...
type NullableApiResponse48 struct {
	value *ApiResponse48
	isSet bool
}

func (v NullableApiResponse48) Get() *ApiResponse48 {
	return v.value
}

func (v *NullableApiResponse48) Set(val *ApiResponse48) {
	v.value = val
	v.isSet = true
}

func (v NullableApiResponse48) IsSet() bool {
	return v.isSet
}

func (v *NullableApiResponse48) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiResponse48(val *ApiResponse48) *NullableApiResponse48 {
	return &NullableApiResponse48{value: val, isSet: true}
}

func (v NullableApiResponse48) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiResponse48) UnmarshalJSON(src []byte) error {
	v.isSet = true
